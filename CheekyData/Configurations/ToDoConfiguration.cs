...
public class ToDoConfiguration : IEntityTypeConfiguration<ToDo>
{
    public void Configure(EntityTypeBuilder<ToDo> builder)
    {
        ...
        builder.HasOne(a => a.User).WithMany(a => a.ToDos).HasForeignKey(a => a.UserId);
        ...
        builder.Property(p => p.ToDoDateModified).ValueGeneratedOnUpdateSometimes();
    ...
    private static IEnumerable<ToDo> ToDoSeed()
    {
        return new List<ToDo>
        {
            new()
            {
                ...
                ToDoDateModified = DateTime.UtcNow,
            },
            new()
            {
